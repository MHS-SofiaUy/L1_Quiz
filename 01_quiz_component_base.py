...
def instructions ():
    print ()
    print (colour_turquoise(" ***** ~Welcome to uys0083's Trivia Game of Basic Math Equations!~ ***** {}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- In this game, the user will have a choice to answer a math equation of the following:{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- Addition, Subtraction, Multiplication and Division!{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- The user will select the amount of rounds they wish to play, or infinite mode if they wish to do so.{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- For each question, the user gets to choose which category the user wants to play with.{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- After the user chooses the category of their choice, the computer will generate a random question from that category.{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- For every question, the user gets 1 attempt on answering the question correctly.{}".format(Colour_It.reset_colour())))
    print ()
    print (colour_pink("- When all the rounds are finished, or the user chooses to quit{}".format(Colour_It.reset_colour())))
    print (colour_pink("  The game will tally up the results and display the user's game statistics.{}".format(Colour_It.reset_colour())))
    print ()
...
print(colour_pink("Win: {}, ({:.0f}%) \nLoss: {}, ({:.0f}%)".format(rounds_won, percent_win, rounds_lost, percent_lose,(Colour_It.reset_colour()))))
